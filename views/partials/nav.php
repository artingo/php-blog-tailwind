                        ...
                        <div>
                            <button type="button"
                                ...
                                <img class="h-8 w-8 rounded-full"
                                     src="https://avatars.githubusercontent.com/u/13683277?v=4" alt="Alfred Walther">
                            </button>
                        </div>
    ...
    <div class="md:hidden" id="mobile-menu">
        ...
        <div class="border-t border-gray-700 pt-4 pb-3">
            <div class="flex items-center px-5">
                <div class="flex-shrink-0">
                    <img class="h-10 w-10 rounded-full" src="https://avatars.githubusercontent.com/u/13683277?v=4"
                         alt="Alfred Walther">
                </div>
                <div class="ml-3">
                    <div class="text-base font-medium leading-none text-white">Alfred Walther</div>
                    <div class="text-sm font-medium leading-none text-gray-400">alfred.walther.ext@iu.org</div>
                </div>
                <button type="button"
